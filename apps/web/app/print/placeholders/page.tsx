...
/**
 * /print/placeholders — binder placeholder sheets (NEO-157).
 *
 * ## This page is a measuring instrument before it is a feature
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-full flex flex-col items-center gap-3">
        <h3 id="sheet-preview-heading" className="text-lg font-semibold">
          Preview
        </h3>

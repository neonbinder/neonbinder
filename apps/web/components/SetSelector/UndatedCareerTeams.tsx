 ...
 *   - A lead the operator does not date is NOT persisted. Jason, 2026-09-06:
 *     no Wikidata lead is stored on the player row — an undated name is a
 *     suggestion for THIS review, and a suggestion nobody acted on is not
 *     data. The lookup returns them again next time the name is reviewed.
 *
 * ## The dashed rule
 *
